...
const TechStack = () => {
  return (
    <section
      id="stack"
      className="flex-col overflow-hidden relative px-2 flex lg:min-h-screen w-full justify-center text-center items-center border-t-[1px] border-t-gray-300 dark:bg-slate-950 dark:border-t-gray-700 bg-gray-100 z-10"
    >
      <div
