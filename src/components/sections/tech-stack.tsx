...
const TechStack = () => {
  return (
    <section className="flex-col overflow-hidden relative px-2 flex min-h-screen w-full justify-center text-center items-center border-t-[1px] border-t-gray-300 dark:bg-slate-950 dark:border-t-gray-700 bg-gray-100 z-10">
      <div
