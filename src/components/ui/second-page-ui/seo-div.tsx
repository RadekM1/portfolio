  ...
  return (
    <div className="flex flex-col md:flex-row w-full gap-5 lg:gap-10 self-center">
      <div className="flex items-start flex-col">
        ...
        <p className="text-sm md:text-base pt-2 max-w-[600px] flex text-start lg:self-start self-center">
      ...
      <div className={`text-base flex-col self-center flex   `}>
        <img
          ...
          loading="lazy"
          className=" drop-shadow-xl py-5 bg-white border-[1px] border-gray-300 max-w-[500px] dark:drop-shadow-none rounded-xl dark:hidden block"
